    ...
    <div className="login-page">
      ...
      <div className="login-target-tabs">
        ...
        <button
          ...
          aria-pressed={loginTarget === LOGIN_TARGETS.EXPO_ADMIN}
        >
          박람회 관리자
        </button>
        <button
          ...
          aria-pressed={loginTarget === LOGIN_TARGETS.SYSTEM_ADMIN}
        >
          시스템 관리자
        </button>
      </div>

      {/* 로그인 카드 — 기존 클래스/마크업 유지 */}
